...
import { CloseOutlined, UserAddOutlined, UsergroupAddOutlined } from '@ant-design/icons-vue'
...
<template>
  <div class="container mx-auto px-4 max-w-3xl rounded-lg p-8">
    <a-table
      ...
      <template #title>
        <div class="flex justify-between items-center">
            ...
            <div class="flex gap-3">
                <a-button type="primary" :icon="h(UserAddOutlined)">Add user</a-button>
                <a-button type="primary" :icon="h(UsergroupAddOutlined)">Add team</a-button>
            </div>
        </div>
      </template>
    </a-table>
