...
SECRET_KEY = "django-insecure-a&n22m3p(&=fo25buypn$a00v9$)jzqsi+)j@3fa@$mmz9o$o_"
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            "context_processors": [
                ...
                "calyvim.context_processors.global_settings"
            ],
        },
    },
]
...
CACHE_MEDIA_ROOT = BASE_DIR / "media" / "cache"
ARCHIVE_MEDIA_ROOT = BASE_DIR / "media" / "archives"
