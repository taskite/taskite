...
<template>
    <BaseLayout>
        <div
            ...
            <a href="https://github.com/taskite/taskite" target="_blank" rel="noopener noreferrer"
            ...
            <div class="rounded-lg flex flex-col md:flex-row max-w-3xl w-full">
                ...
                <div class="md:w-1/2">
                    ...
                    <div class="p-8 shadow-xl bg-white">
                        <slot></slot>
                    </div>
                </div>

                <!-- Bottom-left Status Button -->
                <a href="https://status.taskite.in" target="_blank" rel="noopener noreferrer"
                ...
                <div class="absolute bottom-4 right-4 text-gray-600 text-xs">
                    <p>Need help? Contact us at <a href="mailto:hey@taskite.in"
                            class="underline hover:text-gray-900">hey@taskite.in</a></p>
                </div>
            </div>
        </div>
    </BaseLayout>
